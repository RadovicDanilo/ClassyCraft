		...
		for(ElementPainter elementPainter : diagramView.getElementPainters()) {
			if(elementPainter instanceof InterClassPainter && elementPainter.contains(e.getPoint())) {
				...
				if(diagramElement instanceof Klasa) {
					...
					Interface i = (Interface) ef.createInterClass(InterClassType.CLASS, (ClassyNodeComposite) diagramElement.getParent(), ((Klasa) diagramElement).getVisibility(), ((Klasa) diagramElement).getX() + 15, ((Klasa) diagramElement).getY() + 15);
					...
					Enum anEnum = (Enum) ef.createInterClass(InterClassType.CLASS, (ClassyNodeComposite) diagramElement.getParent(), ((Klasa) diagramElement).getVisibility(), ((Klasa) diagramElement).getX() + 15, ((Klasa) diagramElement).getY() + 15);
