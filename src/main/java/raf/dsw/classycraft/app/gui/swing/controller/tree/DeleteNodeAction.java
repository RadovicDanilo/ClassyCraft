...
public class DeleteNodeAction extends AbstractClassyAction {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(selectedNode.getClassyNode() instanceof Diagram) {
			...
			deleteNodeUpdate((ArrayList<ClassyNode>) ((Package) selectedNode.getClassyNode()).getChildren());
			
		}else {
			deleteNodeUpdate((ArrayList<ClassyNode>) ((Project) selectedNode.getClassyNode()).getChildren());
		}
